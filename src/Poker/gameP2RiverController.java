...
public class gameP2RiverController implements Initializable{
    ...
    void allIn(MouseEvent event) throws IOException
    {
        ...
        Parent gameParent = FXMLLoader.load(getClass().getResource("gameP1Flop.fxml"));
        Scene gameScene = new Scene(gameParent);
        Stage window = (Stage)((Node)event.getSource()).getScene().getWindow();
        window.setScene(gameScene);
        window.show();
    ...
    void check(MouseEvent event) throws IOException
    {
        ...
        if(!Context.getInstance().currentGame().hasAllResponded())
        {
            ...
            if (!Context.getInstance().currentGame().hasAllResponded())
            {
                Parent gameParent = FXMLLoader.load(getClass().getResource("gameP1River.fxml"));
                Scene gameScene = new Scene(gameParent);
                Stage window = (Stage)((Node)event.getSource()).getScene().getWindow();
                window.setScene(gameScene);
                window.show();
